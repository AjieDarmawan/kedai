...
<script src="<?php echo base_url('assets/gretong/js/simpleCart.min.js')?>"> </script>
<script src="<?php echo base_url('assets/gretong/js/amcharts.js')?>"></script>	
<script src="<?php echo base_url('assets/gretong/js/serial.js')?>"></script>	
<script src="<?php echo base_url('assets/gretong/js/light.js')?>"></script>	
<!-- //lined-icons -->
<script src="<?php echo base_url('assets/gretong/js/jquery-1.10.2.min.js')?>"></script>
   <!--pie-chart -->
<script src="<?php echo base_url('assets/gretong/js/pie-chart.js')?>" type="text/javascript"></script>
</head> 
<body>
				...
				<div class="header_bg">
							<div class="header">
								<div class="head-t">
									<div class="logo">
										<!-- Kedai Safwah -->
										<a href="index.html"><img src="<?php echo base_url('assets/gretong/')?>images/logo.jpeg" class="img-responsive" alt="" style="width: 200px"> </a>
									</div>

											<!-- <div class="col-md-12">
											<marquee><h3>Selamat Datang Di Kedai Seribu Bukit</h3></marquee>
											</div> -->
										<!-- start header_right -->
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="<?php echo base_url('App')?>"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
										 ...
										 <li id="menu-academico" ><a href="<?php echo base_url('App/member')?>"><i class="fa fa-file-text-o"></i> <span>Member</span></a></li>
...
<!-- Bootstrap Core JavaScript -->
   ...
   <!-- /Bootstrap Core JavaScript -->
   <!-- real-time -->
<script language="javascript" type="text/javascript" src="<?php echo base_url('assets/gretong/js/jquery.flot.js')?>"></script>
