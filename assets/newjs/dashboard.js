$(document).ready(function() {
    ...
    Highcharts.chart('transjawagrafik', {
        ...
        yAxis: {
            ...
            plotLines: [{
                ...
                label: {
                    ...
                    useHTML: true,
                    text: '<span>(Realisasi)</span><br />90.82%',
                }
                ...
                label: {
                    ...
                    useHTML: true,
                    text: '<span>(Progress)</span><br />68.21 %',
                },
            }]
        },
        tooltip: {
            headerFormat: '<table><tr><th colspan="2"><h3>{point.key}</h3></th></tr><tr><th>Nama Progress</th><th style="color:red; padding-left:10px;">Terakhir Update</th></tr>',
            pointFormat: '<tr><td style="color:{series.color};padding:0">{series.name} </td>' +
                '<td>: &nbsp;<b>{point.tanggal}</td></tr>',
            footerFormat: '</table>',
            shared: true,
            useHTML: true,
            style: {
        ...
        series: [{
            ...
            pointWidth: 7,
            data: [
                { y: 99.95, tanggal: '20 Agustus 2017' },
                { y: 98.32, tanggal: '27 Agustus 2017' },
                { y: 98.17, tanggal: '21 January' },
                { y: 97.69, tanggal: '20 Agustus 2017' },
                { y: 94.7, tanggal: '20 Agustus 2017' },
                { y: 99.18, tanggal: '20 Agustus 2017' },
                { y: 100, tanggal: '20 Agustus 2017' },
                { y: 100, tanggal: '20 Agustus 2017' },
                { y: 100, tanggal: '20 Agustus 2017' },
                { y: 88.316, tanggal: '20 Agustus 2017' },
                { y: 97.19, tanggal: '20 Agustus 2017' },
                { y: 100, tanggal: '20 Agustus 2017' },
                { y: 100, tanggal: '20 Agustus 2017' },
            ],
        }, {
            ...
            pointWidth: 7,
            data: [
                { y: 100, tanggal: '20 July 2017' },
                { y: 68.32, tanggal: '28 July 2017' },
                { y: 78.17, tanggal: '30 July 2017' },
                { y: 47.69, tanggal: '20 July 2017' },
                { y: 34.7, tanggal: '20 July 2017' },
                { y: 29.18, tanggal: '20 July 2017' },
                { y: 100, tanggal: '20 July 2017' },
                { y: 70, tanggal: '20 July 2017' },
                { y: 80, tanggal: '20 July 2017' },
                { y: 28.316, tanggal: '20 July 2017' },
                { y: 97.19, tanggal: '20 July 2017' },
                { y: 30, tanggal: '20 July 2017' },
                { y: 20, tanggal: '20 July 2017' },
            ],
        }, {
            ...
            pointWidth: 7,
            data: [
                { y: 100, tanggal: '20 September 2017' },
                { y: 30, tanggal: '20 September 2017' },
                { y: 55.17, tanggal: '20 September 2017' },
                { y: 43.69, tanggal: '20 September 2017' },
                { y: 67.7, tanggal: '20 September 2017' },
                { y: 89.18, tanggal: '20 September 2017' },
                { y: 80, tanggal: '20 September 2017' },
                { y: 90, tanggal: '20 September 2017' },
                { y: 88, tanggal: '20 September 2017' },
                { y: 100, tanggal: '20 September 2017' },
                { y: 67.19, tanggal: '20 September 2017' },
                { y: 90, tanggal: '20 September 2017' },
                { y: 70, tanggal: '20 September 2017' },
            ],
        }]
    });
