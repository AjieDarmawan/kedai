...
<script type="text/javascript">
	$("document").ready(function(){
        ...
        $("#bayar").click(function(){
        	if($("#ibayar").val()!=""){
        		alert($("#ibayar").val());
        		if($("#ibayar").val().replace(',','')>0){
		      		$.post('<?php echo base_url('app/transaksi_nonmember');?>',$("#transaksi").serialize(),
					...
					alert("Isikan Nominal Pembayaran Dengan Benar");
					$("#ibayar").focus();
				}
			}else{
